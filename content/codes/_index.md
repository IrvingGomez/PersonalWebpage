...
<nav class="section-nav">
  <ul>
    ...
    <ul>
      <li><span class="inline-svg"> <img src="Python-logo.svg"/><a href="/CreateDesignMatricesWithPatsy/CreateDesignMatricesWithPatsy.py">Create design matrices with Patsy.</a></li>
